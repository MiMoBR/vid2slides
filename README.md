...
* Clone this repo. 
* `cd vid2slides`
* `conda env create -f environment.yml` to remove `conda env remove -n vid2slides && conda env create -f environment.yml`
* `conda activate vid2slides`

## Run Usage
* `conda activate vid2slides`
* cd into the `vid2slides` directory, and run:
* `python vid2slides.py ../input-file/adobe-on-site-ai-transformation-part2.mp4 ../output-json/output.json`
...
* `python slides2pdf.py ../output-json/output.json ../output-json/output.pdf` [PDF]
* `python slides2gif.py input_json output_gif` [GIF]
* `python slides2chapter.py input_json` [json chapter]
